...
func (b *breaker) Succeed(){
	...
	case HalfOpen:
		...
		if b.State()==HalfOpen{
			...
			if atomic.LoadInt32(&b.halfopenSuccess) >= b.options.HalfOpenSuccess {
...
// IsAllowed .
func (b *breaker) IsAllowed() bool { return b.IsAllowed()}
...
func (b *breaker) State() State{return State(atomic.LoadInt32((*int32)(&b.state)))}

// Metricer returns the breaker's Metricer
func (b *breaker) Metricer() Metricer {return b.metricer}
