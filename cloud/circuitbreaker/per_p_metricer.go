...
func (b *perPBucket) Failures() int64 {return atomic.LoadInt64(&b.failure)}
...
func (w *perPWindow) Counts()(success, failures, timeouts int64){
...
func (w *perPWindow) getBucket() *perPBucket {return &w.buckets[atomic.LoadInt32(&w.latest)]}
